...
/** Shared GO puck for Google and MapLibre: route arrow + WB star + accuracy halo. */
export const NAV_PUCK_HTML = `<span class="wb-gl-me wb-garrow wb-nav-puck" data-quality="good"><span class="wb-nav-accuracy"></span><svg viewBox="0 0 48 58" width="44" height="54" aria-hidden="true"><path class="wb-puck-shell" d="M24 2 45 52 24 43 3 52Z"/><path class="wb-puck-core" d="M24 9 37 42 24 36 11 42Z"/><path class="wb-puck-star" d="m24 20 2.1 4.3 4.7.7-3.4 3.3.8 4.7-4.2-2.2-4.2 2.2.8-4.7-3.4-3.3 4.7-.7Z"/></svg></span>`;
